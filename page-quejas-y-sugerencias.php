 ...
 <section class="py-16 bg-up-blue-dark text-slate-50 relative overflow-hidden">
  ...
  <div class="max-w-6xl mx-auto px-6 relative z-10">
    ...
    <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="space-y-6">
          <div class="flex gap-4 items-start">
            ...
            <div>
              ...
              <p class="text-base text-slate-200 font-normal">
      ...
      <div id="Reporte" class="bg-white rounded-3xl p-6 md:p-10 shadow-2xl relative w-full">
        ...
        <?php $iup_qf_ready = class_exists( 'IUP_Quejas_Form' ); ?>
        <form id="iup-quejas-form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" class="space-y-6">

          <?php if ( $iup_qf_ready ) : ?>
            <?php wp_nonce_field( 'iup_quejas_form_nonce', 'iup_qf_nonce' ); ?>
            <input type="hidden" name="action" value="iup_quejas_submit" />
            <input type="hidden" name="iup_qf_token" value="<?php echo esc_attr( IUP_Quejas_Form::make_token() ); ?>" />
            <!-- Honeypot anti-spam: debe permanecer vacío (oculto para humanos) -->
            <div class="iup-qf-hp" aria-hidden="true" style="position:absolute !important;left:-9999px !important;top:0;width:1px;height:1px;overflow:hidden;">
              <label for="iup_qf_website">No llenar este campo</label>
              <input type="text" id="iup_qf_website" name="iup_qf_website" tabindex="-1" autocomplete="off" value="" />
            </div>
          <?php endif; ?>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
              ...
              <input type="text" id="name" name="name" placeholder="Ej. Juan Pérez" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-base placeholder:text-slate-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all text-up-text focus:ring-up-blue" />
            </div>

            <div class="space-y-2">
              <label for="phone" class="block text-base font-medium text-slate-700">
                Teléfono <span class="text-slate-200 font-normal">*</span>
              </label>
              <input type="tel" id="phone" name="phone" placeholder="10 dígitos" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-base placeholder:text-slate-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all text-up-text focus:ring-up-blue" />
            </div>
          </div>

          <div class="space-y-2">
            <label for="email" class="block text-base font-medium text-slate-700">
              Correo electrónico <span class="text-slate-200 font-normal">*</span>
            </label>
            <input type="email" id="email" name="email" placeholder="tucorreo@ejemplo.com" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-base placeholder:text-slate-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all text-up-text focus:ring-up-blue" />
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <select id="type" name="type" class="w-full appearance-none bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:border-transparent transition-all cursor-pointer text-up-text focus:ring-up-blue" required>
              ...
              <div class="absolute inset-y-0 right-4 flex items-center pointer-events-none text-slate-200">
          ...
          <div class="space-y-2">
            ...
            <textarea id="message" name="message" rows="4" placeholder="Describe la situación con el mayor detalle posible. Incluye fechas, áreas o personas involucradas si aplica..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-base placeholder:text-slate-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all resize-y text-up-text focus:ring-up-blue" required></textarea>
          </div>
          ...
          <div class="pt-2">
            <label class="flex items-start gap-3 cursor-pointer group">
              ...
              <span class="text-sm text-gray-800 leading-tight font-normal">
          ...
          <?php
          $iup_state = isset( $_GET['iup_quejas'] ) ? sanitize_key( wp_unslash( $_GET['iup_quejas'] ) ) : '';
          $iup_msg   = '';
          $iup_cls   = '';
          if ( ! empty( $iup_qf_ready ) ) {
              $iup_opts = IUP_Quejas_Form::get_options();
              if ( 'ok' === $iup_state ) {
          ...
          ?>
          <div id="iup-qf-status" class="iup-qf-status rounded-xl px-4 py-3 text-base font-medium <?php echo esc_attr( $iup_cls ); ?>" role="status"<?php echo $iup_msg ? '' : ' hidden'; ?>>
      ...
      <div class="border border-gray-200 rounded-2xl bg-gray-50 hover:bg-gray-100/50 transition-colors">
        ...
        <div class="faq-panel open">
          <div class="faq-panel-inner">
            <div class="px-6 pb-6 text-gray-800 text-base leading-relaxed">
